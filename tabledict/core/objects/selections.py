...
from ..utils import _index_function_gen, generate_func, generate_func_any, ROW_OBJ
...
class Table(object):
    ...
    def instant_select(self, selectionfirstarg_data=None, **kwargs):
        """Method for selecting part of the csv document.
    ...
    def instant_any(self, selectionfirstarg_data=None, **kwargs):
        """Method for selecting part of the csv document.
            generates a function based off the parameters given.
    ...
    def unique(self, *args):
        """Grabs specified key from every row
